...
CATEGORIES = {
    ...
    'Coffee/Tea':       ['กาแฟ','กรแฟ','ชา','นมสด','มัทฉะ','ชานม','น้ำชา','น้ำปั่น','ไอศครีม','ค่านม'],
    'Snack':            ['ขนม','ของกินเล่น','กินเล่น','ลูกชิ้น','ลูกชิัน','กล้วยทอด','snack','ผลไม้','ขนมหวาน','ผชไม้'],
    'Stuff':            ['เซเว่น','7-11','maxvalue','ร้านสะดวกซื้อ','ซื้อจ้าว'],
    'Transport':        ['จอดรถ','เดินทาง','ทางด่วน','ค่าส่ง','ส่งของ','ค่าส่งของ','พัสดุ','เติมน้ำมัน','น้ำมัน','easypass','จอดรภ'],
    'น้ำท่อม':          ['น้ำท่อม','ยาน้ำท่อม','น้ำเปล่า','น้ำ'],
    'Shopping':         ['ช้อปปิ้ง','เสื้อผ้า','ของใช้','ซ่อม','ซ่อมรองเท้า','ตัดผม','ล้างรถ','ซักผ้า','หัวพอด','พอด','shopee','lazada','เปลี่ยนแบต'],
